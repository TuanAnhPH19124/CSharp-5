...
namespace DAL.Data
{
    public class DbContexts : DbContext
    {
        ...
        {
            base.OnConfiguring(optionsBuilder.UseSqlServer("Data Source = PHONGTT2710\\SQLEXPRESS; Initial Catalog = csharp5-thucungshopTest; Integrated Security = True; Pooling=False"));
